...
// [[Rcpp::export]]
double BIClog(List &obj, arma::vec &y,  arma::mat &z,  arma::mat &x, double tol = 1e-4)
{
  int n = x.n_rows;
  int p = x.n_cols;
  int q = z.n_cols;
  ...
  // [[Rcpp::export]]
  double BIClogx(List &obj, arma::vec &y,arma::mat &x, double tol = 1e-4)
  {
    int n = x.n_rows;
    int p = x.n_cols;
...
double BIClogr(List &obj, arma::vec indexy, arma::vec &y, arma::mat &z, arma::mat &x, double tol = 1e-4)
{
  int nt = x.n_rows;
  int p = x.n_cols;
  int q = z.n_cols;
...
//[[Rcpp::export]]
double BIClogrx(List &obj, arma::vec indexy, arma::vec &y, arma::mat &x, double tol = 1e-4)
{
  int nt = x.n_rows;
  int p = x.n_cols;
