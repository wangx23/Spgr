...
// [[Rcpp::export]]
Rcpp::List Spgr(arma::vec &y, arma::mat &z, arma::mat &x, 
                     ...
                     int maxiter = 1000, double tolabs = 1e-4, double tolrel = 1e-2)
{
  ...
  double sig2 = sum(square(y - z * eta - yhat))/(n - q - ng*p);
...
//[[Rcpp::export]]
Rcpp::List selectlam(arma::vec &y, arma::mat &z, arma::mat &x, arma::vec &weights,
               ...
               int maxiter = 1000, double tolabs = 1e-4, double tolrel = 1e-2)
{
  ...
  arma::vec etaest = etam.col(index);
