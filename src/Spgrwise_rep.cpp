...
// [[Rcpp::export]]
Rcpp::List Spgrwise_rep_lasso(arma::vec indexy,arma::vec &y, arma::mat &z, arma::mat &x, 
                 ...
                 int maxiter = 1000, double tolabs = 1e-4, double tolrel = 1e-2)
{
  ...
  double sig2 = sum(square(y - z * eta - yhat))/nt;
...
// [[Rcpp::export]]
Rcpp::List Spgrwise_rep_scad(arma::vec indexy,arma::vec &y, arma::mat &z, arma::mat &x, 
                              arma::vec &weights, arma::mat &betam0,
